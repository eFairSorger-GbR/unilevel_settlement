...
ActiveRecord::Schema.define(version: 2021_05_19_175855) do
  ...
  create_table "unilevel_settlement_payout_invoices", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "user_id"
    t.decimal "sub_total_level0"
    t.decimal "sub_total_level1"
    t.decimal "sub_total_level2"
    t.decimal "sub_total"
    t.decimal "total_vat"
    t.decimal "total"
